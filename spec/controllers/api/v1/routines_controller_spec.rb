...
describe API::V1::RoutinesController do
  ...
  describe "GET to index" do
    describe "with no pagination" do
      before do
        get :index, {api_key: @user.api_key, workout_id: @workout, format: "json"}
      end
  ...
  describe "GET to show" do
    describe "for a routine belonging to a user's workout" do
      before do
        get :show, {id: @routine, workout_id: @workout, api_key: @user.api_key, format: "json"}
      end
    ...
    describe "when the routine cannot be found" do
      before do
        ...
        get :show, {id: routine, workout_id: routine.workout, api_key: @user.api_key, format: "json"}
      end
  ...
  describe "POST to create" do
    describe "for a valid post" do
      before do
        post :create, {routine: {exercise_id: create(:bench_press), sets: 5, reps: 12}, workout_id: @workout,
  ...
  describe "PUT to update" do
    describe "for a valid update" do
      before do
        put :update, {id: @routine, routine: {distance: 20}, workout_id: @workout, api_key: @user.api_key, format: "json"}
      end
  ...
  describe "DELETE to destroy" do
    before do
      delete :destroy, {id: @routine, workout_id: @workout, api_key: @user.api_key, format: "json"}
    end
